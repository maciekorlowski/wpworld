...
namespace Wp_World.Wp_World_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private object get_4_Article_publishDateStr(object instance)
        {
            var that = (global::Wp_World.Models.Article)instance;
            return that.publishDateStr;
        }
        private void set_4_Article_publishDateStr(object instance, object Value)
        {
            var that = (global::Wp_World.Models.Article)instance;
            that.publishDateStr = (global::System.String)Value;
        }
        private object get_5_Article_author(object instance)
        {
            var that = (global::Wp_World.Models.Article)instance;
            return that.author;
        }
        private void set_5_Article_author(object instance, object Value)
        {
            var that = (global::Wp_World.Models.Article)instance;
            that.author = (global::System.String)Value;
        }
        private object get_6_Article_description(object instance)
        {
            var that = (global::Wp_World.Models.Article)instance;
            return that.description;
        }
        private void set_6_Article_description(object instance, object Value)
        {
            var that = (global::Wp_World.Models.Article)instance;
            that.description = (global::System.String)Value;
        }
        private object get_7_Article_commentCount(object instance)
        {
            var that = (global::Wp_World.Models.Article)instance;
            return that.commentCount;
        }
        private void set_7_Article_commentCount(object instance, object Value)
        {
            var that = (global::Wp_World.Models.Article)instance;
            that.commentCount = (global::System.Int32)Value;
        }
        private object get_8_Article_image(object instance)
        {
            var that = (global::Wp_World.Models.Article)instance;
            return that.image;
        }
        private void set_8_Article_image(object instance, object Value)
        {
            var that = (global::Wp_World.Models.Article)instance;
            that.image = (global::Windows.UI.Xaml.Media.Imaging.BitmapImage)Value;
        }
        private object get_9_MainPage_SelectedArticle(object instance)
        {
            var that = (global::Wp_World.MainPage)instance;
            return that.SelectedArticle;
        }
        private void set_9_MainPage_SelectedArticle(object instance, object Value)
        {
            var that = (global::Wp_World.MainPage)instance;
        ...
        private global::Windows.UI.Xaml.Markup.IXamlMember CreateXamlMember(string longMemberName)
        {
            ...
            case "Wp_World.Models.Article.publishDateStr":
                ...
                xamlMember.Getter = get_4_Article_publishDateStr;
                xamlMember.Setter = set_4_Article_publishDateStr;
                break;
            case "Wp_World.Models.Article.author":
                userType = (global::Wp_World.Wp_World_XamlTypeInfo.XamlUserType)GetXamlTypeByName("Wp_World.Models.Article");
                xamlMember = new global::Wp_World.Wp_World_XamlTypeInfo.XamlMember(this, "author", "String");
                xamlMember.Getter = get_5_Article_author;
                xamlMember.Setter = set_5_Article_author;
                break;
            case "Wp_World.Models.Article.description":
                ...
                xamlMember.Getter = get_6_Article_description;
                xamlMember.Setter = set_6_Article_description;
                break;
            case "Wp_World.Models.Article.commentCount":
                ...
                xamlMember.Getter = get_7_Article_commentCount;
                xamlMember.Setter = set_7_Article_commentCount;
                break;
            case "Wp_World.Models.Article.image":
                ...
                xamlMember.Getter = get_8_Article_image;
                xamlMember.Setter = set_8_Article_image;
                break;
            case "Wp_World.MainPage.SelectedArticle":
                ...
                xamlMember.Getter = get_9_MainPage_SelectedArticle;
                xamlMember.Setter = set_9_MainPage_SelectedArticle;
                break;
            }
            return xamlMember;
        }
